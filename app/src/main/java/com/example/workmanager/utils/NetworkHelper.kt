...
class NetworkHelper constructor(private val context: Context) {
    ...
    fun isNetworkConnected():Boolean{
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            ...
            val activNetwork = connectivityManager.getNetworkCapabilities(networkCapabilities) ?: return false
            result = when{
                ...
                activNetwork.hasTransport(NetworkCapabilities.TRANSPORT_ETHERNET) -> true
                else -> false
            }
        }else{
